 ...
 * @author jjlet
 */
public class Form_EditarJugador extends javax.swing.JFrame {

    /**
     * Creates new form Form_EditarJugador
     */
    public Form_EditarJugador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Apllido Paterno");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sin Definir", "Arquero", "Defensa", "Medio", "Delantero", " " }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sin Definir", "Item 2", "Item 3", "Item 4" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_EditarJugador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_EditarJugador().setVisible(true);
            }
        });
    }
